...
class AccCatIn extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      accObject: [{}], 
      ...
      <div className="row">
        ...
        <div className="col-md-6">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label htmlFor="account" className="input-group-text small profit" id="basic-addon1">
        ...
        <div className="col-md-6">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
              <label htmlFor="account" className="input-group-text small profit" id="basic-addon1">
                Выберите категорию прихода:</label>
              </div>
          <select
            name="category"
            id="select"
           ...
           <AddProfit account={account} category={category} />
      </div>
    );
}


function AddProfit({ account, category }) {
  ...
  const handleSubmit=(e)=> {
    ...
    if (!account) {
      ...
      setNum('')
       ...
       fetch(`https://protected-shore-46990.herokuapp.com/profit/add?category=`+category + "&date=" + date + "&summ=" + num + "&comment=" + comment + "&account="+ account)
      ...
      <form onSubmit={handleSubmit} >
        <div className="row">
          <div className="col-md-3">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label htmlFor="new-summ" className="input-group-text small profit" id="basic-addon1">
                  Дата:
                </label>
              </div>
              <input
           ...
           <div className="col-md-6">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label htmlFor="new-summ" class="input-group-text small profit" id="basic-addon1">
                  Комментарий:
                </label>
              </div>
              <input
