...
export default function CatOut() {
...
useEffect(async () => {
    ...
    const query = `https://protected-shore-46990.herokuapp.com/categoryOut`;
...
function CatInfo(props) {
  ...
  const delCat = () => {
    ...
    fetch('https://protected-shore-46990.herokuapp.com/categoryOut/del?_id='+props._id)
  ...
  const updCat =  () => {
    ...
    fetch(`https://protected-shore-46990.herokuapp.com/categoryOut/upd?_id=`+props._id+'&category='+newCat)
       .then(window.location.reload())
  }
  const styleNone = {
  display: 'none'
